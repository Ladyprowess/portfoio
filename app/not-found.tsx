...
export default function NotFound() {
  return <main className="min-h-screen bg-bg">
    ...
    <section className="relative overflow-hidden border-b border-ink-border px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
      <div aria-hidden className="absolute left-1/2 top-20 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-primary/[0.12] blur-3xl" />
      <div className="relative mx-auto max-w-[1080px]">
        <div className="grid overflow-hidden rounded-[2rem] border border-ink-border bg-surface lg:grid-cols-[0.72fr_1.28fr]">
          <div className="flex min-h-64 items-center justify-center bg-primary p-10 text-on-primary lg:min-h-[34rem]"><span className="font-display text-[clamp(6rem,14vw,11rem)] font-extrabold leading-none tracking-[-0.08em]">404</span></div>
          <div className="flex flex-col justify-center p-8 md:p-14">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row"><Link href="/" className="inline-flex min-h-12 items-center justify-center rounded-full bg-primary px-7 py-3 text-sm font-bold text-on-primary transition hover:bg-primary-dim">Return home</Link><Link href="/blog" className="inline-flex min-h-12 items-center justify-center rounded-full border border-ink-border px-7 py-3 text-sm font-bold transition hover:border-primary/40">Read the blog</Link></div>
