...
export const blogPosts: BlogPost[] = [
  {
    ...
    accent: '#41d7c7',
    body: [
      `There are people who find their calling late in life, after years of searching, after failed attempts and long detours. And then there are people who were always it. They just had to survive long enough to become it fully. Ngozi Peace Okafor, known across digital spaces as Lady Prowess, is the second kind of person. Her story does not begin with a business plan or a mentor or a scholarship. It begins with a phone, a quiet love for words, and a girl who simply could not stop writing.`,
      `In 2016, Ngozi started writing. Not for money. Not for an audience. Just because she wanted to. She was writing on her phone, putting words together the way some people hum to themselves, naturally, almost without thinking. That same year, she gained admission into the University of Uyo. A new city, a new environment, and as luck or destiny would have it, the people she found herself around were already thinking about technology. She did not know at the time how much that would matter.`,
      `But university brought its own pressure. She was a student who needed to take care of herself, and nobody was going to hand her that. So she did what she knew how to do. She wrote. She started writing assignments for other students. Seminar papers. Workshop documents. Projects. Whatever they needed put together in words, she was the one they came to. And they paid her for it. It was quiet, unglamorous work. There was nothing inspiring about it on the surface. But it kept her alive in school. It kept food within reach and kept her standing when things were tight. And somehow, through all of it, she never stopped loving the craft itself. She was not just writing to survive. She was surviving through the one thing that had always felt like hers.`,
